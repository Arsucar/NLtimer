...
internal fun parseFontFamily(fontFamily: String): FontFamily? {
...
internal fun parseFontStyle(fontStyle: String): FontStyle? {
...
internal fun parseTextDecoration(textDecoration: String): TextDecoration? {
...
internal fun parseTextAlign(textAlign: String): TextAlign? {
