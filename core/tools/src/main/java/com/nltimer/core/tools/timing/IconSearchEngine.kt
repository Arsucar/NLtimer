...
object IconSearchEngine {
    ...
    private val HUGE_ICON_DATA: List<Pair<String, List<String>>> = listOf(
        ...
        "CheckList" to listOf("checklist", "list", "清单", "待办", "checklist"),
        "CheckmarkBadge01" to listOf("badge", "review", "assessment", "评审", "审核", "评估", "review", "approval"),
        ...
        "Alert01" to listOf("alert", "warning", "urgent", "告警", "警告", "紧急", "重要"),
        "AlertCircle" to listOf("alert", "warning", "circle", "urgent", "告警", "警告", "紧急"),
        ...
        "Notification01" to listOf("notification", "bell", "通知", "提醒", "urgent", "紧急"),
        ...
        "ChefHat" to listOf("chef", "hat", "cooking", "kitchen", "cooking", "厨师帽", "烹饪", "做饭", "厨房"),
        "Chef" to listOf("chef", "cook", "cooking", "kitchen", "cooking", "厨师", "做饭", "厨房"),
        ...
        "AlarmClock" to listOf("alarm", "clock", "闹钟", "urgent", "紧急", "重要"),
        ...
        "Flag01" to listOf("flag", "标记", "旗帜", "urgent", "紧急", "优先级"),
